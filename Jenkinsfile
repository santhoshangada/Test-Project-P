pipeline {
	    ...
	    parameters {
	         string(name: 'tomcat_dev', defaultValue: '172.31.47.223', description: 'Staging Server')
	         string(name: 'tomcat_prod', defaultValue: '172.31.47.223', description: 'Production Server')
	    }
